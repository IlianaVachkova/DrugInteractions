...
namespace DrugInteractions.Web.Infrastructure.Mapping
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            var allTypes = AppDomain
                .CurrentDomain
                .GetAssemblies()
                .Where(a => a.GetName().Name.Contains("DrugInteractions"))
            ...
            allTypes
                ...
                .ToList()
                .ForEach(mapping => this.CreateMap(mapping.Destination, mapping.Source));
